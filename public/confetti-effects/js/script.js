...
document.getElementById('basic_cannon').addEventListener("click", function(){
  confetti({
    particleCount: 100,
    spread: 70,
    origin: { y: 0.6 }
...
document.getElementById('random_direction').addEventListener("click", function(){
...
document.getElementById('realistic_look').addEventListener("click", function(){
  var count = 200;
  var defaults = {
    origin: { y: 0.7 }
  };
...
document.getElementById('school_pride').addEventListener("click", function(){
